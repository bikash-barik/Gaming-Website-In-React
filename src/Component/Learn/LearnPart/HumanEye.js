    ...
    <div>
      <div id="about">
        ...
        <div className="border p-5">
          <MuscularSystem
          imgcont={"https://nkcf.org/wp-content/uploads/2017/08/human-eye-diagram.jpg"}
            heading={"Human Eye"}
            title={
      ...
      <div id="parteye">
        ...
        <MuscularSystem
        imgcont={"https://images.ctfassets.net/u4vv676b8z52/cIeQcGiLYzM5r432HZVCj/d41d5c6e2883c74393b5bac469ecd06a/sclera-678x446.gif?fm=jpg&q=80"}
          heading={"Sclera:-"}
          title={
        ...
        />
        <MuscularSystem
        imgcont={"https://study.com/cimages/multimages/16/eye_diagram.png"}
          heading={"Pupil:-"}
          title={
        ...
        />
        <MuscularSystem
        imgcont={"https://d1avenlh0i1xmr.cloudfront.net/5d86b290-2196-4ded-8069-8843fe588337/function-of-iris-in-dim-and-bright-light---teachoo.jpg"}
          heading={"Iris:-"}
          title={
        ...
        />
        <MuscularSystem
        imgcont={"https://images.ctfassets.net/u4vv676b8z52/5KgAiEOt7rEbyU5dudm54C/419b39e0e8ed4f7d8d8f00b7dcfef3a2/contact-lens-basics-678x446-compressor.jpg?fm=jpg&q=80"}
          heading={"Lens:-"}
          title={
        ...
        />
        <MuscularSystem
        imgcont={"https://images.ctfassets.net/u4vv676b8z52/NynW9QHIfw9IEDtld2TpR/1004457633787a264b132648f471d1e8/uvea-678x446.gif?fm=jpg&q=80"}
        ...
        <MuscularSystem
        imgcont={"https://marvel-b1-cdn.bc0a.com/f00000000038905/www.aao.org/image.axd?id=b6cfa3ed-9e01-4ab6-9064-acb586eac3ef&t=636397784671200000"} 
        ...
        <MuscularSystem
        imgcont={"https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs00261-019-02037-9/MediaObjects/261_2019_2037_Fig2_HTML.png"} 
        ...
        <MuscularSystem
        imgcont={"https://images.medicinenet.com/images/illustrations/eye_cutaway.jpg"} 
        heading={"Optic nerve:-"} 
        ...
        <MuscularSystem
        imgcont={"https://marvel-b1-cdn.bc0a.com/f00000000038905/www.aao.org/image.axd?id=221f6da5-7e35-4a16-8593-651e6c0c78a7&t=635942715552400000"} 
        heading={"Cornea:-"} 
