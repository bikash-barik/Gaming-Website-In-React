...
export default class HeaderLearning extends Component {
  render() {
    return (
      <div>
        <nav class="navbar navbar-light mb-5 fixed-top" style={{background:" #222"}}>
          ...
          <div class="col-sm-12 col-md-2 desktopNone">
            ...
            <h3 className="p-2 sm-text-center text-white">Human Anatomy <img  src="https://img.icons8.com/ios/26/ffffff/learn-more.png"/></h3>
            <img
                src="../images/logo1.png"
                alt=""
                width="150"
